const global = {
  ...
  api: {
    ...
    apiKey: '37e91f0adcb46c977218bfedf23592f5',
  },
};
...
async function displayPopularShows() {
  ...
  results.forEach((show) => {
    ...
    div.classList.add('card');
    div.innerHTML = `
          <a href="/src/html/tv-details.html?id=${show.id}">
           ${
             show.poster_path
...
function displaySearchResults(results) {
  ...
  results.forEach((result) => {
    ...
    div.classList.add('card');
    div.innerHTML = `
          <a href="/src/html/${global.search.type}-details.html?id=${result.id}">
           ${
             result.poster_path
               ...
               : `<img src="/src/images/no-image.jpg" class="card-img-top" alt="${
                   global.search.type === 'movie' ? result.title : result.name
                 }" />`
           }
          </a>
    ...
    ).innerHTML = `<h2>${results.length} of ${global.search.totalResults} result for ${global.search.term}</h2>`;
